...
def gold_room():
    print ("This is full of gold. How much gold you want to take?")
...
def bear_room():
    ...
    while True:
        ...
        if next == "take honey":
            ...
            print ("The bear has moved from the door, you can go through it now. You win!")
            bear_moved = True
...
def start():
    ...
    print ("THere is a door to youor right and left.")
